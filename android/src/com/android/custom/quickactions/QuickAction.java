 ...
 */
package com.android.custom.quickactions;
...
public class QuickAction extends CustomPopupWindow {
	...
	public void show () {
		...
		//As xPos is used as an offset to the arrowPlacement, we need to make sure
		// that it's not out of bounds, or else the arrow will be placed out of bounds
		if(xPos < 0 ){
